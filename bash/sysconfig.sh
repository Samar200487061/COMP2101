...
function error-message {
  echo "we couldn't run your code... Sorry ;P" >&2
}
...
function error-exit {
  echo "we couldn't run your code... Sorry ;P... Because $1"
  exit
}
...
function cleanup {
  # Removing all the temporary files created by this script
  rm /tmp/*.$$
  echo "All temporary files created by this script are deleted"
  exit
}
